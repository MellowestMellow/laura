    ...
    this.srvMantenimientoDepartamentoService.deleteTipoDepartamento(idTipoDepartamento).subscribe(
      (res: any) => {
        ...
        this.messageService.add({
          severity: 'success',
          summary: 'Operación Exitosa',
          detail: res.message || 'Tipo de Departamento eliminado exitosamente',
          life: 3000
        });
      },
      (error: any) => {
        ...
        this.isLoadingEliminar = false;
        // Mostrar mensaje de error
        const msg = error.error?.mensaje || 'Error al eliminar el Tipo de Departamento';
        this.messageService.add({
          severity: 'error',
          summary: 'Operación Fallida',
          detail: msg,
  ...
  eliminarDepartamento() {
    ...
    this.srvMantenimientoDepartamentoService.deleteDepartamento(idDepartamento).subscribe(
      ...
      (error: any) => {
        ...
        this.isLoadingEliminar = false;
        // Mostrar mensaje de error
        const msg = error.error?.mensaje || 'Error al eliminar el departamento';
        this.messageService.add({
          severity: 'error',
          summary: 'Operación Fallida',
          detail: msg,
