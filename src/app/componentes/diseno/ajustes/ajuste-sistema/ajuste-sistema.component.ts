...
export class AjusteSistemaComponent implements OnInit {
  ...
  ajustes: any[] = [
    ...
    //   descripcion: 'Gestiona el mantenimiento de catálogos del plan operativo, incluyendo variables, metas, actividades, recursos y tablas de relación.',
    //   icono: 'pi pi-calendar',
    //   ruta: '/panel/plan/operativo'
    // },
    // {
    //   nombre: 'Reservación',
