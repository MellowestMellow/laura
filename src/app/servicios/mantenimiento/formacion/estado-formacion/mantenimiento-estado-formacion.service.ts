...
export class MantenimientoEstadoFormacionService {
  ...
  // Métodos HTTP - POST
  postEstadoFormacion(): Observable<any> {
    // Obtener el token desde el AuthService
    const token = this.authService.getJwtToken();
    ...
    // Hacer la solicitud GET incluyendo los headers
    return this.http.post<any>(this.apiUrl + '/formacion/estado', { headers });
  }

  // Métodos HTTP - PUT
  putEstadoFormacion(): Observable<any> {
    // Obtener el token desde el AuthService
    const token = this.authService.getJwtToken();
    ...
    // Hacer la solicitud GET incluyendo los headers
    return this.http.put<any>(this.apiUrl + '/formacion/estado', { headers });
  }
