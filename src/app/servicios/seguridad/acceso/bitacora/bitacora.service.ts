...
export class BitacoraService {
  ...
  getBitacora(): Observable<any> {
    ...
    return this.http.get<any>(this.apiUrl + '/seguridad/bitacora', { headers });
  }

   // Métodos HTTP - POST
  postBitacora(Rol: any): Observable<any> {
    // Obtener el token desde el AuthService
  
    // Hacer la solicitud GET incluyendo los headers
    return this.http.post<any>(this.apiUrl + '/seguridad/bitacora', Rol);
  }
