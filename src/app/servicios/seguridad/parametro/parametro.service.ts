...
export class ParametroService {
  ...
  getPlantilla(): Observable<any> {
    ...
    return this.http.get<any>(this.apiUrl + '/plantilla/', { headers });
  }

  getPlantillaPorId(idParametros : string ): Observable<any> {
    // Obtener el token desde el AuthService
    const token = this.authService.getJwtToken();
    ...
    // Hacer la solicitud GET incluyendo los headers
    return this.http.get<any>(this.apiUrl + `/plantilla/descargar/${idParametros}`, { headers });
  }
